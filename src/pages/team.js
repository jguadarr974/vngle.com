...
const TeamPage = () => {
  const team = [
    ...
    {name:"Jennifer", position:"Engineering Intern: Front page"},
    {name:"Nanami", position:"Engineering Intern: Front page"},
    {name:"Chelsea", position:"Engineering Intern: Front page"},
    {name:"Israel", position:"Engineering Intern: CMS"},
    {name:"Robert", position:"Engineering Intern: CMS"},
    {name:"Muzaffar", position:"Engineering Intern: CMS"},
    {name:"Christopher", position:"Engineering Intern: Mobile"},
    {name:"Shiming", position:"Engineering Intern: Mobile"},
  ].map((profile, i) => {
